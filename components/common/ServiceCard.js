      ...
      <div className="ServiceCardWapper">
        <div className="ServiceCard">
          ...
          <div className="Service-body">
            <Link prefetch as={`/u/${service.user.username}`} href={`/user?username=${service.user.username}`}>
              <a className="img-user-card">
                <img
                  alt="Servicio"
                  src={service.user.avatar_small}
                  width="40" height="40"
            ...
            <div className="service-content">
              ...
              <p className="project-blurb">
                <a className="descriptionService" href={`/service/${service.id}`}>{ capitalize(service.description.substr(0, 80)) }...</a>
              </p>
              <div className="project-card-footer">
                <div className="project-blurb-location">
